...
async function deleteTest({id}) {
    ...
    return {info: `Test with id: ${id} deleted`};
}
...
async function getFingerPrint({id}) {
    ...
    return {result: fingerPrint.toObject()};
}
...
async function approveFingerPrint({id}) {
    ...
    return {result: savedApproval.toObject()};
}
...
async function getDifference({id}) {
    ...
    return {result: difference.toObject()};
}
...
// Main page
app.use('/', lessMiddleware(appRoot + '/developers/main-page', {
...
app.use('/testpage/css', lessMiddleware(appRoot + '/test-page/styles', {
...
app.use('/apipage/css', lessMiddleware(appRoot + '/api-page/styles', {
...
app.use('/diffpage/css', lessMiddleware(appRoot + '/diff-page/styles', {
