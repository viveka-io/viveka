var fs          = require('fs'),
    log = require('./logger')('difference-generator', 'yellow'),
...
function compareFingerprints(a, b, cb) {
    var imgUrlA = 'tmp' + a.screenshot,
        imgUrlB = 'tmp' + b.screenshot;

    log.info(`Reading baseline image ${imgUrlA}`);
    ...
    log.info(`Reading target image ${imgUrlB}`);
